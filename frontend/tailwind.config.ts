...
const config: Config = {
  ...
  theme: {
    colors: {
      "bg-color-white50": "rgba(255, 255, 255, 1)",
      "bg-color-white100": "rgba(253, 253, 253, 1)",
      "bg-color-white200": "rgba(253, 253, 253, 1)",
      "bg-color-white300": "rgba(252, 252, 252, 1)",
      "bg-color-white400": "rgba(251, 251, 251, 1)",
      "bg-color-white500": "rgba(250, 250, 250, 1)",
      "bg-color-white600": "rgba(228, 228, 228, 1)",
      "bg-color-white700": "rgba(178, 178, 178, 1)",
      "bg-color-white800": "rgba(138, 138, 138, 1)",
      "bg-color-white900": "rgba(105, 105, 105, 1)",
      "primary-color-violet50": "rgba(233, 233, 236, 1)",
      "primary-color-violet100": "rgba(185, 186, 197, 1)",
      "primary-color-violet200": "rgba(152, 152, 169, 1)",
      "primary-color-violet300": "rgba(104, 106, 130, 1)",
      "primary-color-violet400": "rgba(75, 77, 105, 1)",
      "primary-color-violet500": "rgba(30, 32, 68, 1)",
      "primary-color-violet600": "rgba(27, 29, 62, 1)",
      "primary-color-violet700": "rgba(21, 23, 48, 1)",
      "primary-color-violet800": "rgba(17, 18, 37, 1)",
      "primary-color-violet900": "rgba(13, 13, 29, 1)",
      "secondary-color-green50": "rgba(230, 250, 244, 1)",
      "secondary-color-green100": "rgba(178, 238, 220, 1)",
      "secondary-color-green200": "rgba(141, 230, 203, 1)",
      "secondary-color-green300": "rgba(90, 218, 179, 1)",
      "secondary-color-green400": "rgba(57, 211, 165, 1)",
      "secondary-color-green500": "rgba(8, 200, 142, 1)",
      "secondary-color-green600": "rgba(7, 182, 129, 1)",
      "secondary-color-green700": "rgba(6, 142, 101, 1)",
      "secondary-color-green800": "rgba(4, 110, 78, 1)",
      "secondary-color-green900": "rgba(3, 84, 60, 1)",
      "success-green50": "rgba(234, 249, 238, 1)",
      "success-green100": "rgba(189, 235, 201, 1)",
      "success-green200": "rgba(157, 226, 175, 1)",
      "success-green300": "rgba(113, 212, 138, 1)",
      "success-green400": "rgba(85, 204, 115, 1)",
      "success-green500": "rgba(43, 191, 80, 1)",
      "success-green600": "rgba(39, 174, 73, 1)",
      "success-green700": "rgba(31, 136, 57, 1)",
      "success-green800": "rgba(24, 105, 44, 1)",
      "success-green900": "rgba(18, 80, 34, 1)",
